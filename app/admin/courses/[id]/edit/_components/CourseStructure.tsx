...
export const CourseStructure = ({ data }: iAppProp) => {
    ...
    return (
        ...
        >
            <Card className=" overflow-hidden">
                <CardHeader className="flex justify-center flex-col border-b border-border">
                                        ...
                                        <Collapsible open={item.isOpen} onOpenChange={() => toggleChapter(item.id)}>
                                            <div className="flex items-center justify-between p-3 border-b border-border">
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <p className="cursor-pointer hover:text-primary ml-4">{item.title}</p>
                                                </div>
                                                <div>
                                                    <Button
                                                        size={'icon'}
